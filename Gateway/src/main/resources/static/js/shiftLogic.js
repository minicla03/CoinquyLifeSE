// Recupera il token di autenticazione dal localStorage
    ...
    // Funzione per caricare i coinquilini dalla lista salvata nel localStorage
    function local() {
        ...
        // Codice commentato per eventuale caricamento dei turni da localStorage
    ...
    // Imposta i link di navigazione nella navbar
    ...
    // Gestisce l'invio del form di indisponibilità
    ...
    // Recupera e mostra il planning dei turni
    ...
    // Aggiunge l'evento per visualizzare il planning
    document.getElementById("viewPlanningLink").addEventListener("click", (e) => {
        e.preventDefault()
        fetchPlanning()
    })

    // Popola la select dei coinquilini
    ...
    // Renderizza il calendario dei turni
    ...
    // Gestisce la conferma del completamento di un compito
    ...
    // Assegna i punti al coinquilino che ha completato il compito
    ...
    // Gestione creazione nuovo compito tramite form
    ...
    // Recupera tutti i turni dal backend
    ...
    // Inizializza le indisponibilità per tutti i coinquilini
